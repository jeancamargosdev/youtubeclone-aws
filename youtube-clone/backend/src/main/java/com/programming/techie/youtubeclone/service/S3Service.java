...
public class S3Service implements FileService {
    ...
    public static final String BUCKET_NAME = "awsyoutubeclonebucket";
    private final AmazonS3Client awsS3Client;

    @Override
    //String because once you uploaded the file you'll get the URL of that particular video
    public String uploadFile(MultipartFile file){
        //Upload file do AWS S3
